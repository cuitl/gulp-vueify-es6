<template>
    <div ref="root"
         style="user-select: none;-webkit-user-select: none;overflow: hidden">
        <div class="sliderPanel"
             :class="{transitionAni:ani}"
             :style="{height:height,transform:translateX}">
            <div v-for="item in itemList"
                 class="verticalCenter picbox"
                 :style="{left:item.x+'px'}">
                <img class="image"
                     :style="{width:width,top:top,backgroundColor:item.color}"
                     :src="item.url"
                     style="min-height: 100%">
            </div>
        </div>
        <div @click="clickLeft"
             class="arrowLeft verticalCenter horizaCenter">
            <img class="arrow"
                 src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1492770347&di=ab57e46a39e3774d0facd6b2e658512d&imgtype=jpg&er=1&src=http%3A%2F%2Fpic.58pic.com%2F58pic%2F14%2F61%2F87%2F08N58PICGYn_1024.jpg"
                 style="transform: rotate(180deg)">
        </div>
        <div @click="clickRight"
             class="arrowRight verticalCenter horizaCenter">
            <img class="arrow"
                 src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1492770347&di=ab57e46a39e3774d0facd6b2e658512d&imgtype=jpg&er=1&src=http%3A%2F%2Fpic.58pic.com%2F58pic%2F14%2F61%2F87%2F08N58PICGYn_1024.jpg">
        </div>
        ...
        <div class="sliderBar horizaCenter">
            <div v-for="(item,index) in imgArray"
                 @click="clickSliderCircle(index)"
                 class="circle"
                 :class="{circleSelected:item.selected}">
            </div>
        </div>
    </div>
</template>
